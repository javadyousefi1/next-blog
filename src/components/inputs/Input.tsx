...
const Input: React.FC<InputPropType> = ({ type, onChange, name, placeHolder, className, value, error, disabled }) => {
    ...
    return (<>
        <input placeholder={placeHolder} value={value} type={type} onChange={onChange} name={name} className={inputStyle} disabled={disabled} />
    </>);
}
